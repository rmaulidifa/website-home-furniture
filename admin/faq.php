...
<body>
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>FAQ</center></h1>
                    <p class="card-description"> Frequently Ask Questions </p>
                   
                      <form action="act_faq_create.php" method="POST">
                      <div class="form-group">
                        <label for="subjek">Subjek</label>
                        <input type="text" class="form-control" id="subjek" placeholder="Masukkan Subjek" name="subjek">
                      </div>
                      <div class="form-group">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
             ...
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_faq']?></td> 
             <td scope="row"><?php echo $data['subjek']?></td> 
             <td scope="row"><?php echo $data['pertanyaan']?></td> 
             <td scope="row"><?php echo $data['jawaban']?></td> 
             <td> 
             <div class="text-center"> 
             <button type=" button" class=" btn-danger btn-sm"><a href="delete_faq.php?id=<?php echo $data['id_faq'] ?>" class="text-white">Hapus</a></button>
             <button type=" button" class=" btn-danger btn-sm"><a href="view_faq.php?id=<?php echo $data['id_faq'] ?>" class="text-white">Edit</a></button>
                          </div>
                        </td>
                      </tr>
             <?php }?> 
