...
<body>
                ...
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    ...
                    <p class="card-description"> Tambahkan Produk Terbaru </p>
                      ...
                      <form action="act_product_create.php" method="POST">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
               include "koneksi.php"; 
               $query = "select * from stok inner join produk on produk.id_produk = stok.id_produk order by nama_produk ASC"; 
               $output = $connect->query($query); 

               while ($data = $output->fetch_array()) { 
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_produk']?></td> 
             ...
             <button type=" button" class=" btn-danger btn-sm"><a href="delete_product.php?id=<?php echo $data['id_produk'] ?>" class="text-white">Hapus</a></button>
             <button type=" button" class=" btn-danger btn-sm"><a href="view_produk.php?id=<?php echo $data['id_produk'] ?>" class="text-white">Edit</a></button>
                          </div>
                        </td>
                      </tr>
             <?php }?> 
