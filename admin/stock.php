...
<body>
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>STOCK PRODUCT</center></h1>
                    <p class="card-description"> Tambahkan Stok Produk </p>

                    <form action="act_stok_create.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jumlah" placeholder="Masukkan Jumlah Stok" name="jumlah">
                      </div>
                      <br>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
               include "koneksi.php"; 
               $query = "select * from stok inner join produk on produk.id_produk = stok.id_produk"; 
               $output = $connect->query($query); 

               while ($data = $output->fetch_array()) :
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_stok']?></td> 
             <td scope="row"><?php echo $data['nama_produk']?></td> 
             <td scope="row"><?php echo $data['jumlah']?></td> 
             <td> 
             <div class="text-center"> 
         <button type=" button" class=" btn-danger btn-sm"><a href="delete_stok.php?id=<?php echo $data['id_stok'] ?>" class="text-white">Hapus</a></button>
        <button type=" button" class=" btn-danger btn-sm"><a href="view_stok.php?id=<?php echo $data['id_stok'] ?>" class="text-white">Edit</a></button>
