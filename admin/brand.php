...
<body>
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>BRAND PRODUCT</center></h1>
                    <p class="card-description"> Tambahkan Brand Produk </p>
                    <!-- <form class="forms-sample"> -->
                    <form action="act_brand_create.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="brand" placeholder="Masukkan Nama Brand" name="nama_brand">
                      </div>
                      <br>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Daftar Brand Produk</h4>
       ...
       <?php 
               include "koneksi.php"; 
               $query = "select * from brand inner join produk on produk.id_produk = brand.id_produk"; 
               $output = $connect->query($query); 

               while ($data = $output->fetch_array()) :
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_brand']?></td> 
             <td scope="row"><?php echo $data['nama_produk']?></td> 
             <td scope="row"><?php echo $data['nama_brand']?></td> 
             <td> 
             <div class="text-center"> 
         
         <button type=" button" class=" btn-danger btn-sm"><a href="delete_brand.php?id=<?php echo $data['id_brand'] ?>" class="text-white">Hapus</a></button>
        <button type=" button" class=" btn-danger btn-sm"><a href="view_brand.php?id=<?php echo $data['id_brand'] ?>" class="text-white">Edit</a></button>
