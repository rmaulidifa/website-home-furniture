...
<body>
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>CATEGORY PRODUCT</center></h1>
                    <p class="card-description"> Tambahkan Kategori Produk </p>
                    <!-- <form class="forms-sample"> -->
                    <form action="act_kategori_create.php" method="POST">
                      ...
                      <!-- <div class="form-group">
                        ...
                        <input type="deskripsi" class="form-control" id="exampleInputDeskripsi4" placeholder="Masukkan Deskripsi">
                      </div> -->
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
               include "koneksi.php"; 
               $query = "select * from kategori inner join produk on produk.id_produk = kategori.id_produk"; 
               $output = $connect->query($query); 

               while ($data = $output->fetch_array()) :
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_kategori']?></td> 
             <td scope="row"><?php echo $data['nama_produk']?></td> 
             <td scope="row"><?php echo $data['nama_kategori']?></td> 
             <td> 
             <div class="text-center"> 
         <button type=" button" class=" btn-danger btn-sm"><a href="delete_kategori.php?id=<?php echo $data['id_kategori'] ?>" class="text-white">Hapus</a></button>
        <button type=" button" class=" btn-danger btn-sm"><a href="view_kategori.php?id=<?php echo $data['id_kategori'] ?>" class="text-white">Edit</a></button>
