            ...
            <div class="slider-body px-1">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link px-3" href="profil.php">
                        <i class="fa fa-user fa-lg box-icon" aria-hidden="true"></i>Alternatif
                    </a>
                    <hr class="soft my-1 bg-white">
                    <a class="nav-link px-3" href="product.php">
                        <i class="fa fa-dropbox fa-lg box-icon" aria-hidden="true"></i>Kriteria
                    </a>
                    <a class="nav-link px-3" href="category.php">
                        <i class="fa fa-dropbox fa-lg box-icon" aria-hidden="true"></i>Bobot
                    </a>
                    <a class="nav-link px-3" href="brand.php">
                        <i class="fa fa-dropbox fa-lg box-icon" aria-hidden="true"></i>Skala
                    </a>
                    <a class="nav-link px-3" href="stock.php">
                        <i class="fa fa-dropbox fa-lg box-icon" aria-hidden="true"></i>Matrix Keputusan
                    </a>
                    <hr class="soft my-1 bg-white">
                    <a class="nav-link px-3" href="recap.php">
                        <i class="fa fa-calendar fa-lg box-icon" aria-hidden="true"></i>Result
                    <!-- </a>
...
<?php
                    include "koneksi.php";
                    $id = $_GET['id'];
                    $query = "select * from alternatif where id_kandidat='$id'";
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>ALTERNATIF</center></h1>
                    <p class="card-description"> Tambahkan Alternatif Baru </p>
                    <!-- <form class="forms-sample"> -->
                    <form action="edit_brand.php" method="POST">
                    <div class="form-group">
                        <label for="id_kandidat">Id Kandidat</label>
                        <input type="text" class="form-control" id="id_kandidat" placeholder="Masukkan Id Alternatif" name="id_kandidat">
                      </div>
                      <div class="form-group">
                        <label for="nama_kandidat">Nama Kandidat</label>
                        <input type="text" class="form-control" id="nama_kandidat" placeholder="Masukkan Nama Kandidat" name="nama_kandidat">
                      </div>
                      <br>
