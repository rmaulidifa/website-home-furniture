        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>KATEGORI PRODUCT</center></h1>
                    <p class="card-description"> Tambahkan Kategori Produk </p>
                    <!-- <form class="forms-sample"> -->
                    <form action="edit_kategori.php" method="POST">
                    <div class="form-group">
                        <label for="id_kategori">Id Kategori</label>
                        <input type="text" class="form-control" id="id_kategori" placeholder="Masukkan Id Kategori" name="id_kategori">
                      </div>
                      <div class="form-group">
