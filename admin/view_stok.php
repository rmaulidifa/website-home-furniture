...
<?php
                    include "koneksi.php";
                    $id = $_GET['id'];
                    $query = "select * from stok where id_stok = '$id'";
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>STOK PRODUCT</center></h1>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_stok" placeholder="Masukkan Id Stok" name="id_stok">
                      </div>
                      <div class="form-group">
