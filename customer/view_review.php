          ...
          <div class="col-lg-10">
            <form action="edit_review.php" method="POST">
                      <div class="form-group">
                        <label for="id_review"></label>
                        <input type="text" class="form-control" id="id_review" placeholder="Masukkan ID Review" name="id_review">
                      </div>
                      <br>
              <div class="row">
              ...
              <div class="my-3">
                ...
                <!-- <div class="sent-message">Your Review Produk has been sent. Thank you!</div>
              </div>
              <div class="text-center"><button type="submit">Send FAQ</button></div> -->
            </form>
          </div>
