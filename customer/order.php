  ...
  <!-- <main id="main"> -->
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:5%">
                    <h1 class="card-title"><center>DETAIL ORDER</center></h1>
                    <p class="card-description"><center>Please fill in this form to order.</center></p>
                    <!-- <form class="forms-sample"> -->
                    <form action="act_order_create.php" method="POST">
                      ...
                      <button class="btn btn-light"><a href = transaksi.php>Next</a></button>
                    </form>
                  </div>
                </div>
            </div>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
         ...
         <button type=" button" class=" btn-danger btn-sm"><a href="delete_order.php?id=<?php echo $data['id_pesan'] ?>" class="text-white">Hapus</a></button>
        <button type=" button" class=" btn-danger btn-sm"><a href="view_order.php?id=<?php echo $data['id_pesan'] ?>" class="text-white">Edit</a></button>
