            ...
            <div class="card">
              ...
              <div style="margin-top:2%">
                ...
                <div class="form-group">
                        <label for="id_pay">ID Payment</label>
                        <input type="text" class="form-control" id="id_pay" placeholder="Masukkan ID Payment" name="id_pay">
                      </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <!-- <input class="col-md-12"> -->
                    <br>
                    <select id="no_rekening" name="no_rekening">
                  ...
                  <div class="form-group">
                    <label for="tanggal_pay">Tanggal Payment</label>
                    <input type="date" class="form-control" id="tanggal_pay" name="tanggal_pay">
                  </div>
