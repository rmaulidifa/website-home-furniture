...
<body>
  ...
  <!-- <main id="main"> -->
        ...
        <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div style="margin-top:2%">
                    ...
                    <form action="act_trans_create.php" method="POST">
                    <div class="form-group">
                      ...
                      <button class="btn btn-light"><a href = payment.php>Next</a></button>
                    </form>
                  </div>
                </div>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
       ...
       <?php 
               include "koneksi.php"; 
              //  $query = "select * from transaksi inner join pesan on pesan.id_pesan = transaksi.id_pesan"; 
             ...
             ?> 
             <tr> 
             <td scope="row"><?php echo $data['id_trans']?></td> 
             <td scope="row"><?php echo $data['nama_customer']?></td> 
             <td scope="row"><?php echo $data['alamat']?></td> 
             <td scope="row"><?php echo $data['jasa_kirim']?></td> 
             <td scope="row"><?php echo $data['tanggal']?></td> 
             
             <td> 
             <div class="text-center"> 
         
         <button type=" button" class=" btn-danger btn-sm"><a href="delete_transaksi.php?id=<?php echo $data['id_trans'] ?>" class="text-white">Hapus</a></button>
        <button type=" button" class=" btn-danger btn-sm"><a href="view_transaksi.php?id=<?php echo $data['id_trans'] ?>" class="text-white">Edit</a></button>
